...
# Generate individual HTML pages - NO back link, full dark theme
...
<body>
    <div class="container">
        <div class="toolbar">
            <span class="toolbar-title">{article['title']}</span>
        ...
        <button class="exit-fullscreen" onclick="toggleFullscreen()">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
print(f"\\nTotal: {len(article_data)} files generated")
